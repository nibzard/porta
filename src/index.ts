...
// Capability: independent browser sessions (SPEC.md section 14.4).
export {
  BROWSER_ATTRIBUTE_KEYS,
  ...
  browserCreateResultSchema,
  browserInspectInputSchema,
  browserInspectResultSchema,
...
// Capability: dependent service exposure and connections (SPEC.md 14.6).
export {
  CONNECTION_RESOURCE_TYPE,
  SERVICE_ATTRIBUTE_KEYS,
  ...
  serviceCloseInputSchema,
  serviceCloseResultSchema,
  serviceConnectInputSchema,
  serviceConnectResultSchema,
  serviceExposeInputSchema,
  serviceExposeResultSchema,
  serviceStillValid,
